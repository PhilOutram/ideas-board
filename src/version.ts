...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-06-19',
    notes: [
      'Email a whole idea: open an idea and use the new ✉ button in the footer (next to Copy) to send it to your configured work email - the idea title and its boards go in the message.',
      'The edit pencil icon now slopes the natural way for a right hand (mirrored horizontally).',
    ],
  },
  {
    version: 'v0.28',
  ...
  },
  {
    ...
    date: '2026-06-12',
    notes: [
      'Move an idea to another page: open an idea and use the new ➡ button (between Copy and Delete) to pick a target page from a tree, and the idea relocates there. The move is atomic - the idea is never lost in transit.',
    ],
  },
  {
    version: 'v0.25',
